...
use crate::{BoundVar, ControlFlow, DebruijnIndex, Interner, Traverse, Visitor};

/// Visitor extensions.
pub trait VisitExt<I: Interner>: Traverse<I> {
...
impl<T, I: Interner> VisitExt<I> for T where T: Traverse<I> {}
